...
@Component({
  selector: 'app-home',
  imports: [RouterLink, MOVEMENT_DIRECTIVES, VoltButton, VoltBadge],
  template: `
    <!-- Hero Section with animated aurora background -->
    <section class="relative overflow-hidden px-6 pt-20 pb-16 md:pt-28 md:pb-24">
      <div class="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(99,102,241,0.15),transparent)]"></div>
      <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[radial-gradient(circle,rgba(99,102,241,0.12)_0%,transparent_70%)] blur-3xl"></div>
      ...
      <div class="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <h1 class="mb-6 text-5xl font-extrabold tracking-tight md:text-7xl" [move]="'fade-up'" [moveDelay]="100">
          Andersseen
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4" [move]="'fade-up'" [moveDelay]="300">
          <a routerLink="/volt-ui">
            <volt-button variant="solid" size="lg" class="min-w-[160px]">Explorar libs</volt-button>
          </a>
          <a href="https://github.com/Andersseen" target="_blank" rel="noopener">
            <volt-button variant="outline" size="lg" class="min-w-[160px]">
        ...
        <!-- Stats -->
        <div class="mt-16 grid grid-cols-2 gap-8 md:grid-cols-4" [move]="'fade-up'" [moveDelay]="400">
          @for (stat of stats; track stat.label) {
            <div class="text-center">
              <div class="text-3xl font-bold text-white md:text-4xl">{{ stat.value }}</div>
              <div class="mt-1 text-sm text-white/40">{{ stat.label }}</div>
            </div>
          }
        </div>
      </div>
    ...
    <section class="px-6 py-16 md:py-24">
      <div class="mx-auto max-w-5xl">
        <div class="mb-12 text-center" [move]="'fade-up'">
          <h2 class="text-3xl font-bold md:text-4xl">Cuatro librerías, un ecosistema</h2>
          <p class="mt-4 text-white/50">Cada una resuelve un problema específico. Juntas, cubren todo tu UI.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <a routerLink="/volt-ui" class="group relative block overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-1 transition-all duration-500 hover:border-blue-500/20 hover:bg-white/[0.04]"
            ...
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500/5 to-transparent p-6">
              ...
              <div class="relative z-10">
                <div class="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-white/40">Componentes estilizados</p>
                  </div>
                </div>
                <p class="mb-6 text-sm leading-relaxed text-white/50">
                  Componentes UI accesibles construidos sobre ng-primitives. Temas, variantes y CLI propio.
                </p>
                <!-- Mini preview -->
          ...
          <a routerLink="/quartz" class="group relative block overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-1 transition-all duration-500 hover:border-emerald-500/20 hover:bg-white/[0.04]"
            ...
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-emerald-500/5 to-transparent p-6">
              <div class="absolute top-0 right-0 p-4 opacity-20 transition-opacity group-hover:opacity-40">
              ...
              <div class="relative z-10">
                <div class="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-white/40">Primitivas headless</p>
                  </div>
                </div>
                <p class="mb-6 text-sm leading-relaxed text-white/50">
                  Lógica compleja sin opiniones de estilo. Toast, dialogs, overlays, tooltips y más.
                </p>
                <div class="flex flex-wrap items-center gap-2">
          ...
          <a routerLink="/angular-movement" class="group relative block overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-1 transition-all duration-500 hover:border-amber-500/20 hover:bg-white/[0.04]"
            ...
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-amber-500/5 to-transparent p-6">
              <div class="absolute top-0 right-0 p-4 opacity-20 transition-opacity group-hover:opacity-40">
              ...
              <div class="relative z-10">
                <div class="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-white/40">Animaciones declarativas</p>
                  </div>
                </div>
                <p class="mb-6 text-sm leading-relaxed text-white/50">
                  Sistema declarativo de animaciones con WAAPI y springs. Scroll, hover, parallax y presencia.
                </p>
                <div class="flex flex-wrap items-center gap-2">
          ...
          <a routerLink="/lumen-icons" class="group relative block overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-1 transition-all duration-500 hover:border-sky-500/20 hover:bg-white/[0.04]"
            ...
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-sky-500/5 to-transparent p-6">
              <div class="absolute top-0 right-0 p-4 opacity-20 transition-opacity group-hover:opacity-40">
              ...
              <div class="relative z-10">
                <div class="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-white/40">Iconos SVG tree-shakeable</p>
                  </div>
                </div>
                <p class="mb-6 text-sm leading-relaxed text-white/50">
    ...
    <!-- Tech Stack Section -->
    <section class="border-t border-white/5 px-6 py-16 md:py-24">
      <div class="mx-auto max-w-5xl text-center" [move]="'fade-up'">
        <h2 class="mb-4 text-2xl font-bold md:text-3xl">Construido con lo mejor del ecosistema</h2>
        <p class="mb-10 text-white/50">Moderno, rápido y preparado para producción.</p>
...
export default class HomePage {
  ...
  constructor() {
    this.seo.update({
      ...
      description: 'Un ecosistema de librerías Angular modernas, accesibles y animadas. Volt UI, Quartz, Angular Movement y Lumen Icons.',
    });
  }

  readonly stats = [
    { value: '4', label: 'Librerías' },
    { value: '30+', label: 'Componentes' },
    { value: 'Angular 21', label: 'Última versión' },
