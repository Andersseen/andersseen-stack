  ...
  template: `
    <app-demo-layout accentRgb="16 185 129">
      <app-demo-header
        ...
        packageName="@quartz-headless/primitives"
...
export default class QuartzPage {
  ...
  readonly installExample = `import { DialogService, ToastService } from '@quartz-headless/primitives';

// Standalone directives/services are imported where needed.
// Add @quartz-headless/core when using overlay/focus/viewport utilities.`;
}
