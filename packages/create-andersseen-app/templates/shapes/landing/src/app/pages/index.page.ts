...
import { buttonVariants, VoltButton } from '@voltui/components';
...
@Component({
  ...
  imports: [PublicLayout, VoltButton, LmnBoltIcon, LmnEyeIcon, LmnPuzzlePieceIcon],
    ...
    <app-public-layout>
      <section class="mx-auto flex w-full max-w-5xl flex-col items-center gap-6 px-6 py-20 text-center sm:py-28">
        ...
        <div class="flex flex-wrap items-center justify-center gap-3">
          <volt-button type="button" (click)="markStarted()">Start building</volt-button>
          <a href="#features" [class]="secondaryCtaClass">Learn more</a>
        </div>

        @if (started()) {
          <p class="text-sm font-medium text-primary">Ready when you are.</p>
        }
      </section>
